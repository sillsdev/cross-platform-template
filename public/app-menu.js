      ...
      submenu: [
        {
          ...
          click: () => {
            shell.openPath(
              path.join(execFolder(), 'help/Cross_Platform_Template_Help.chm')
            );
          },
        },
        {
          ...
          click: () => {
            shell.openExternal(
              'https://community.scripture.software.sil.org/c/cross-platform-template/10'
            );
          },
        },
        {
          ...
          click: () => {
            shell.openExternal(
              'https://software.sil.org/cross-platform-template/'
            );
          },
        },
      ],
